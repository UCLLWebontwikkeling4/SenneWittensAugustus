...
import TrainingAdd from "../../pages/addtraining";

const TrainingAddForm: React.FC = () => {
    ...
    const handleSubmit = (event: any) => {
        event.preventDefault(); 
            TrainingService.addTraining(titleInput,dateInput, kmInput, avg_heartrateInput, avg_speedInput, parseInt(sessionStorage.getItem('id')), 0)
    };
